...
public class MapMethods {
    public static void main(String[] args) {
        //student name & score:
        Map<String,Integer> students=new HashMap<>();//Key does not duplicated but value does!!
        ...
        students.put("Ali",85);
        students.put("Ali",86);
        students.put("Ali",87);//en son bu yazılır diğer aliler gider 3. sıradaki dahil!!! Key does not duplicated
