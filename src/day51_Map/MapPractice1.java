...
/*
        for (String key : employeeMap.keySet()) {//employeeMap.keySet().for yaptık
...
*/
        ...
        for (Map.Entry<String, String> entry : employeeMap.entrySet()) {//employeeMap.entrySet().for yaptık
        ...
        for (Map.Entry<String, String> eachPair : employeeMap.entrySet()) {
            String eachKey = eachPair.getKey();//name
            String eachValue = eachPair.getValue();//gender
