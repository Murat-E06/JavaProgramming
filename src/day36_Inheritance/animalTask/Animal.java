...
public class Animal {
    ...
    public void setInfo(String name, String bread, char gender, int age, String size, String color) {
        this.name = name;//we change it constructor to setInfo method?
        this.bread = bread;//in the setInfo we call the instances one by one not automaticly like const. method
        this.gender = gender;
        this.age = age;
        this.size = size;
        this.color = color;
