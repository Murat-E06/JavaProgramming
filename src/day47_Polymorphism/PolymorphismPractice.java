...
public class PolymorphismPractice {
    public static void main(String[] args) {
        ...
        for(Car eachCar  : cars ){
            ...
            if(eachCar instanceof Toyota){//instance check if the objecet is certain class
        ...
        Car carWithHighestMileage = cars[0],//assume the first car highest mileage
                carWithLowestMileage =  cars[0];//same approach
