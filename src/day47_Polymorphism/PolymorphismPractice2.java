...
public class PolymorphismPractice2 {
    public static void main(String[] args) {
        /*
        day 43 den çağırdı muhtar bende olmadığı için hata veriyor!!
        ...
        for (Employee scrumMember : scrumMembers) {
            if(scrumMember instanceof Tester){
                testers.add((Tester) scrumMember);//casting yaptı employee olanı tester yaptı
            }

            if(scrumMember instanceof Developer){
                developers.add((Developer) scrumMember);//aynı şekilde employee olanı developer yaptı polimorphism!!
            }
