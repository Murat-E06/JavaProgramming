...
public class CydeoStudent {
    ...
    public String toString() {
        return "CydeoStudent{" +
                ...
                ", school='" + schoolName + '\'' +//static
                ", programming language='" + programmingLanguage + '\'' +//static, instance method(toString) include both instance and static
                '}';
    }
}
...
methods:
printSchoolName(); printSecretCode(); attendClass(): study() toString()
 */
