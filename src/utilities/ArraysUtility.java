...
public class ArraysUtility {
    ...
    //NO MAIN METHOD İMPORTANT!!! because the others classes includes main method if we create than it will bw duplicated main methods and gives error!!!

    //Once a create custom method than we overloading to the others!!!


    //prints each integer of an integer array in seperates lines
    ...
    //prints each double of a double array in seperates lines
    ...
    //prints each char of a char array in seperates lines
    ...
    //prints each String of a char array in seperates lines
    ...
    public static boolean contains(int[] array, int element) {
        //  {1,2,3,4},  5
        boolean result = false;// baştan false kabul ediyoruz ta ki true olana kadar (eğer varsa)
    ...
    //adds the given element to int array, returns new array
    ...
    //adds the given element to double array, returns new array
    ...
    // add a String after the last index of a String array, returns new array
    ...
    // add a char after last index of a char array, returns new array
    ...
    // returns the freq. of the given element from the given array  [1,1,1,2,3,4,5] /  1
    ...
    // returns the freq. of the given element from the given array
